...
sel_upd = st.selectbox("업데이트 정보", ['보기', 'V2.5', '첫번째 무중단 업데이트', '두번째 무중단 업데이트'])
...
elif sel_upd == '첫번째 무중단 업데이트':
  st.markdown("- '시간의 조각들 OST' 추가\n")
elif sel_upd == '두번째 무중단 업데이트':
  st.markdown("- '최신 AI 숏폼' 탭에 작품을 '서로의 온기 2: 서현과 민오'로 교체\n")
  st.markdown("- 학교 카테고리에 '서로의 온기 2: 서현과 민오' 추가\n")
